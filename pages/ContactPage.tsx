                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <main className="bg-surface p-8 sm:p-12 rounded-lg shadow-xl text-center">
                            ...
                            <div className="mt-8">
                                ...
                                <a href={`mailto:${t('contact.email.address')}`} className="text-primary text-xl font-semibold hover:underline break-all">
                            ...
                            <div className="mt-8">
                                <div className="flex justify-center items-center mb-4">
                                    ...
                                    <div className="text-left">
                                        <h3 className="text-lg font-bold text-slate-700">{t('appName')}</h3>
                        ...
                        <div className="bg-surface p-8 rounded-lg shadow-xl">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4 text-center">
                                {t('contact.video.title', { default: 'Découvrez notre solution' })}
                            </h2>
                            <p className="text-slate-600 mb-6 text-center">
                                {t('contact.video.subtitle', { default: 'Regardez comment Nexus Support Hub peut transformer votre support client.' })}
                            </p>
                            ...
                            <div className="text-center">
                                <VideoPlayer 
                                    buttonText={t('contact.video.watchFull', { default: 'Voir la présentation complète' })}
                                    className="text-sm"
                                />
                            </div>
                        </div>
