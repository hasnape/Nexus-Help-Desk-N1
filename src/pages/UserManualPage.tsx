                    ...
                    <article className="prose prose-slate max-w-none prose-h2:text-primary prose-h2:border-b prose-h2:pb-2 prose-h3:text-secondary-dark">
                        ...
                        <section>
                            ...
                            <ol>
                                ...
                                <li>{t('userManual.section.gettingStarted.manager.step3', { default: 'A "Secret Code" field will appear. Enter the creation code `123456` to prove you are authorized to create a new company.' })}</li>
                                ...
                                <li>{t('userManual.section.gettingStarted.manager.step5', { default: 'Complete the rest of the form and click "Sign Up".' })}</li>
                            </ol>
